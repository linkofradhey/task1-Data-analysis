...
/**
 * DataTypeAnalyzer - Equivalent of Python's df.dtypes
 *
 * Pandas automatically infers whether a column is numeric (int64/float64),
 * a date, or text (object). We replicate that by scanning every value in
 * each column and deciding the dominant type.
 */
public class DataTypeAnalyzer {
    ...
    /**
     * Returns a map of column name -> inferred type, just like df.dtypes
     */
